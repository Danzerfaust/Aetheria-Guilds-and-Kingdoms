...
namespace SOAGuildsAndKingdomsPVP.src.pvp
{
    ...
    public class PVPManager
    {
        ...
        private const string STORAGE_KEY = "soaguildsandkingdomspvp_playerdata";
        private SOAGuildsAndKingdomsModSystem? guildModSystem;
        ...
        public PVPManager(ICoreServerAPI api)
        {
            ...
            {
                guildModSystem = api.ModLoader.GetModSystem<SOAGuildsAndKingdomsModSystem>();
                if (guildModSystem == null)
                {
                    api.Logger.Error("[PVP] CRITICAL: Could not find SOAGuildsAndKingdoms mod system!");
                    api.Logger.Error("[PVP] This mod requires the SOAGuildsAndKingdoms mod to be installed and loaded.");
                    api.Logger.Error("[PVP] PVP functionality will be disabled.");
                }
                else
                {
                    api.Logger.Notification("[PVP] Successfully integrated with SOAGuildsAndKingdoms mod");
        ...
        public bool TogglePVP(string playerUid, out string message)
        {
            ...
            if (guildModSystem?.GuildManager == null)
            {
                message = "PVP system requires the SOAGuildsAndKingdoms mod to be installed.";
                return false;
            }
