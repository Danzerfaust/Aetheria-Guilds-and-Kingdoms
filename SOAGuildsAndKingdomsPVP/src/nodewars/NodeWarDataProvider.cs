...
namespace SOAGuildsAndKingdomsPVP.src.nodewars
{
    ...
    public class NodeWarDataProvider
    {
        ...
        private readonly SOAGuildsAndKingdomsModSystem guildModSystem;

        public NodeWarDataProvider(ICoreServerAPI api, NodeWarManager manager, SOAGuildsAndKingdomsModSystem guildMod)
        {
            sapi = api;
        ...
        /// </summary>
        public SOAGuildsAndKingdoms.src.network.NodeWarDataResponsePacket ConvertToNetworkPacket(NodeWarTabData data)
        {
            var packet = new SOAGuildsAndKingdoms.src.network.NodeWarDataResponsePacket
            {
                PlayerUid = "", // Will be set by network handler
                ControlledNodes = data.ControlledNodes.Select(node => new SOAGuildsAndKingdoms.src.network.ControlledNodeDto
                {
                    NodeId = node.NodeId,
                    NodeName = node.NodeName,
                ...
                CurrentWar = data.CurrentWar != null ? new SOAGuildsAndKingdoms.src.network.CurrentWarDto
                {
                    ...
                    YourGuildProgress = data.CurrentWar.YourGuildProgress != null ? new SOAGuildsAndKingdoms.src.network.GuildWarProgressDto
                    {
                ...
                AvailableWars = data.AvailableWars.Select(war => new SOAGuildsAndKingdoms.src.network.AvailableWarDto
                {
                    NodeId = war.NodeId,
                ...
                CurrentSignup = data.CurrentSignup != null ? new SOAGuildsAndKingdoms.src.network.CurrentSignupDto
                {
