...
{
    /// <summary>
    /// Integrates NodeWarManager with the SOAGuildsAndKingdoms guild system
    ...
    public class NodeWarGuildIntegration
    {
        ...
        public NodeWarGuildIntegration(ICoreServerAPI api, NodeWarManager nodeWarManager, SOAGuildsAndKingdomsModSystem guildModSystem)
        {
            this.sapi = api;
