    ...
    public class QuestBoardBlock : Block
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, $"questBoardInteraction-{Variant["questType"]}", () =>
            {
                return new WorldInteraction[] { new()
                    {
                        ActionLangCode = $"srguildsandkingdoms:quests-view-{Variant["questType"]}",
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            if (world.Side == EnumAppSide.Client)
            {
                ...
                var modSystem = capi.ModLoader.GetModSystem<SRGuildsAndKingdomsModSystem>();
                ...
                if (isWeeklyBoard)
                {
                    ...
                    if (owningGuild == null)
                    {
                        capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:quest-board-not-in-claim"));
                        return false;
                    }
                    ...
                    {
                        capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:quest-board-wrong-claim"));
                        return false;
                    }
                }
