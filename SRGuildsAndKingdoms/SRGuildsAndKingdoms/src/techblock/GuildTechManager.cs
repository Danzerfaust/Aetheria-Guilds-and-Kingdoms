...
namespace SRGuildsAndKingdoms.src.techblock
{
    ...
    /// </summary>
    public class GuildTechManager(ICoreAPI api, System.Func<string, SRGuildsAndKingdoms.src.guilds.Guild>? getGuildFunc = null, System.Action<string>? markDirtyAction = null)
    {
        ...
        /// </summary>
        private void InitializePersonalUnlock(SRGuildsAndKingdoms.src.guilds.Guild guild, string playerUid, int techId, TechBlock techBlock)
        {
