...
namespace SRGuildsAndKingdoms.src.techblock
{
    ...
    public class TechBlocksConfig
    {
        ...
        public static TechBlocksConfig LoadFromFile(ICoreAPI api, string filename = "techblocks.json", string? serverIdentifier = null)
        {
            ...
            {
                var serverConfigPath = api.GetOrCreateDataPath($"ModConfig/SRGuildsAndKingdoms/servers/{serverIdentifier}");
            ...
            var configPath = api.GetOrCreateDataPath("ModConfig/SRGuildsAndKingdoms");
