...
namespace SRGuildsAndKingdoms.src.patches
{
    ...
    public class WorldMapTestBlockAccessPatch
    {
        public static bool Prefix(IPlayer player, BlockSelection blockSel, EnumBlockAccessFlags accessType, out string claimant, ref EnumWorldAccessResponse __result)
        {
            ...
            var modSystem = api.ModLoader?.GetModSystem<SRGuildsAndKingdomsModSystem>();
            ...
            int chunkX = SRGuildsAndKingdoms.src.guilds.LandClaim.FloorDiv(blockSel.Position.X, SRGuildsAndKingdoms.src.guilds.LandClaim.ChunkSize);
            int chunkZ = SRGuildsAndKingdoms.src.guilds.LandClaim.FloorDiv(blockSel.Position.Z, SRGuildsAndKingdoms.src.guilds.LandClaim.ChunkSize);
