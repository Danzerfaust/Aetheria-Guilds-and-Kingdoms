...
namespace SRGuildsAndKingdoms.src.gui
{
    ...
    internal class DialogGuildManageRoles : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildmanageroles", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:manage-roles-title"), OnTitleBarCloseClicked)
            ...
            // Instructions
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:manage-roles-instructions"),
            ...
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:existing-roles"),
            ...
            // Add new role button
            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:create-new-role"), OnCreateNewRole,
                ElementBounds.Fixed(0, listTop + roleListHeight + spacing, leftColumnWidth, elementHeight),
                EnumButtonStyle.Normal);

            // === RIGHT COLUMN: Role Editor ===
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:role-editor"),
            ...
            if (selectedRoleName != null)
            {
                ...
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:role-name"),
                ...
                if (!isDefaultRole)
                {
                    composer.AddStaticText(Lang.Get("srguildsandkingdoms:hierarchy"),
                        CairoFont.WhiteSmallText(), ElementBounds.Fixed(rightColumnX, editorTop, 100, elementHeight));
                ...
                // Permissions section
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:permissions"),
                ...
                if (!isDefaultRole)
                {
                    ...
                    {
                        composer.AddSmallButton(Lang.Get("srguildsandkingdoms:save-role"), OnSaveRole,
                            ElementBounds.Fixed(rightColumnX, editorTop, 100, elementHeight),
                            EnumButtonStyle.Normal);

                        composer.AddSmallButton(Lang.Get("srguildsandkingdoms:cancel"), OnCancelChanges,
                    ...
                    // Delete role button
                    composer.AddSmallButton(Lang.Get("srguildsandkingdoms:delete-role"), OnDeleteRole,
                        ElementBounds.Fixed(rightColumnX, editorTop, 100, elementHeight),
                ...
                else
                {
                    ...
                    composer.AddStaticText(Lang.Get("srguildsandkingdoms:default-role-notice"),
            ...
            else
            {
                // No role selected
                var editorTop = top + elementHeight + spacing;
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:select-role-to-edit"),
                    CairoFont.WhiteSmallText().WithColor(new double[] { 0.7, 0.7, 0.7, 1.0 }),
                    ElementBounds.Fixed(rightColumnX, editorTop, rightColumnWidth, elementHeight * 2));
            }
            ...
            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:close"), OnClose,
            ...
            string permissionName, GuildPermission permission, GuildPermission currentPerms, bool isReadOnly)
        {
            ...
            composer.AddStaticText(Lang.Get($"srguildsandkingdoms:permission-{permissionName.ToLower()}"),
        ...
        private bool OnSaveRole()
        {
            ...
            hasUnsavedChanges = false;
            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-saved", selectedRoleName));
        ...
        private bool OnDeleteRole()
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-delete-default-role"));
                return false;
            }
            ...
            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-deleted"));
        ...
        private bool OnClose()
        {
            if (hasUnsavedChanges)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unsaved-changes-warning"));
    ...
    internal class DialogCreateRole : GuiDialog
    {
        ...
        public DialogCreateRole(ICoreClientAPI capi, SRGuildsAndKingdomsModSystem modSystem,
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildcreaterole", dialogBounds)
                .AddShadedDialogBG(bgBounds)
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:create-new-role-title"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);
            ...
            // Instructions
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:create-role-instructions"),
        ...
        private bool OnCreateClick()
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:please-enter-role-name"));
                return false;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-name-too-short"));
                return false;
            }

            if (roleName.Length > 20)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-name-too-long"));
                return false;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-name-reserved"));
                return false;
            }
