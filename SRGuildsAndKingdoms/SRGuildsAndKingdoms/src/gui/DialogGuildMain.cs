    ...
    public class DialogGuildMain : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildmain", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:guild-main-title", currentGuild.Name), OnTitleBarCloseClicked)
        ...
        private void SetupNoGuildDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("noguild", dialogBounds)
                .AddShadedDialogBG(bgBounds)
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:no-guild-title"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);

            composer.AddStaticText(Lang.Get("srguildsandkingdoms:no-guild-message"), CairoFont.WhiteDetailText(),
                ElementBounds.Fixed(0, 20, 400, 50));

            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:create-guild"), OnCreateGuild,
        ...
        private bool OnClaimingToggle()
        {
            ...
            if (isClaimingMode)
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-home-mode-enabled-map"));
                }
                else
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claiming-mode-enabled-map"));
                }
            ...
            else
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claiming-mode-disabled"));
            }
        ...
        private bool OnUnclaimingToggle()
        {
            ...
            if (isUnclaimingMode)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unclaiming-mode-enabled"));
            }
            else
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unclaiming-mode-disabled"));
            }
        ...
        private bool OnUnclaimCurrentChunk()
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-not-claimed"));
                return true;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-unclaim-guild-home"));
                return true;
            }*/
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-unclaim-outpost"));
                return true;
            }*/
            ...
            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unclaim-submitted", chunkX, chunkZ));
        ...
        private void ProcessChunkClaim(int chunkX, int chunkZ, bool sendImmediately)
        {
            ...
            if (alreadyClaimed)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-already-claimed"));
                return;
            }
            ...
            if (!sendImmediately)
            {
                ...
                if (alreadyPending)
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-already-pending"));
                    return;
                }
            }
            ...
            if (needsGuildHome)
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-home-area-blocked"));
                    return;
                }
                ...
                if (sendImmediately)
                {
                    ...
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-home-claim-submitted", chunkX, chunkZ));
                }
                else
                {
                    pendingClaims.AddRange(homeChunks);
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-home-area-added-to-pending", chunkX, chunkZ));
                }
            }
            else
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claim-must-be-adjacent"));
                    return;
                }
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-expand-from-outpost"));
                    return;
                }
                ...
                if (sendImmediately)
                {
                    ...
                    {
                        capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-already-claimed-by-other"));
                        return;
                    }
                }
                ...
                if (sendImmediately)
                {
                    ...
                    networkHandler.SendGuildClaimLandRequest(chunkX, chunkZ);
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claim-submitted", chunkX, chunkZ));
                }
                else
                {
                    pendingClaims.Add((chunkX, chunkZ));
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claim-added-to-pending", chunkX, chunkZ));
                }
            }
        ...
        public void OnMapChunkUnclaimed(int chunkX, int chunkZ)
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-already-pending-unclaim"));
                return;
            }

            pendingUnclaims.Add((chunkX, chunkZ));
            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unclaim-added-to-pending", chunkX, chunkZ));
        ...
        private bool OnSavePendingClaims()
        {
            ...
            if (networkHandler != null)
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:claims-submitted", pendingClaims.Count));
                pendingClaims.Clear();
        ...
        private bool OnSavePendingUnclaims()
        {
            ...
            if (networkHandler != null)
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:unclaims-submitted", pendingUnclaims.Count));
        ...
        private bool OnSaveSettings()
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:no-changes-to-save"));
                return true;
            }
            ...
            if (pendingPrimaryColor != ColorToHex(currentGuild.DisplayColor))
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:invalid-primary-color"));
            ...
            if (pendingSecondaryColor != ColorToHex(currentGuild.SecondaryColor))
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:invalid-secondary-color"));
                    return false; // Don't save if validation fails
                }
            }
            ...
            if (pendingGuildName != currentGuild.Name && !string.IsNullOrWhiteSpace(pendingGuildName))
            {
                ...
                capi.Network.GetChannel("srguildsandkingdoms:guild").SendPacket(nameChangePacket);
            }
            ...
            if (pendingDescription != currentGuild.Description)
            {
                ...
                capi.Network.GetChannel("srguildsandkingdoms:guild").SendPacket(descriptionChangePacket);
            }
            ...
            if (pendingPrimaryColor != ColorToHex(currentGuild.DisplayColor))
            {
                if (TryParseHexColor(pendingPrimaryColor ?? "", out int primaryColor))
                {
                    ...
                    capi.Network.GetChannel("srguildsandkingdoms:guild").SendPacket(primaryColorPacket);
                }
            }
            ...
            if (pendingSecondaryColor != ColorToHex(currentGuild.SecondaryColor))
            {
                if (TryParseHexColor(pendingSecondaryColor ?? "", out int secondaryColor))
                {
                    ...
                    capi.Network.GetChannel("srguildsandkingdoms:guild").SendPacket(secondaryColorPacket);
                }
            }

            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:settings-saved"));
		...
		private bool OnNodeWarSignup()
		{
			...
			var pvpMod = capi.ModLoader.GetModSystem("SRGuildsAndKingdomsPVP.PVPModSystem");
			if (pvpMod == null)
			{
        ...
        private bool OnLeaveGuild()
        {
            ...
            if (currentGuild.PlayerRole == "Leader")
            {
                ...
                {
                    confirmMessage = Lang.Get("srguildsandkingdoms:confirm-disband-guild", currentGuild.Name);
                }
                else
                {
                    // Leader with other members - show error message
                    capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:leader-cannot-leave"));
                    return true;
                }
            }
            else
            {
                confirmMessage = Lang.Get("srguildsandkingdoms:confirm-leave-guild", currentGuild.Name);
            }
        ...
        private bool OnCreateOutpost()
        {
            ...
            if (!hasGuildHome)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:outpost-requires-guild-home"));
                return true;
            }

            if (outpostCount >= maxOutposts)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:max-outposts-reached", outpostCount, maxOutposts));
                return true;
            }
        ...
        private void OnOutpostCreationRequested(string outpostName)
        {
            ...
            var playerPos = capi.World.Player.Entity.Pos.AsBlockPos;
            int chunkX = SRGuildsAndKingdoms.src.guilds.LandClaim.FloorDiv(playerPos.X, SRGuildsAndKingdoms.src.guilds.LandClaim.ChunkSize);
            int chunkZ = SRGuildsAndKingdoms.src.guilds.LandClaim.FloorDiv(playerPos.Z, SRGuildsAndKingdoms.src.guilds.LandClaim.ChunkSize);
            ...
            if (alreadyClaimed)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:chunk-already-claimed-outpost", chunkX, chunkZ));
                return;
            }
            ...
            if (networkHandler != null)
            {
                ...
                string message = string.IsNullOrEmpty(outpostName)
                    ? Lang.Get("srguildsandkingdoms:outpost-creation-requested", chunkX, chunkZ)
                    : Lang.Get("srguildsandkingdoms:outpost-creation-requested-named", outpostName, chunkX, chunkZ);
        ...
        /// </summary>
        private void OnNodeWarDataReceived(SRGuildsAndKingdoms.src.network.NodeWarDataResponsePacket packet)
        {
    ...
    internal class DialogGuildLeaveConfirm : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildleaveconfirm", dialogBounds)
                .AddShadedDialogBG(bgBounds)
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:leave-guild-title"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);
            ...
            // Buttons
            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:confirm"), OnConfirmClick,
