    ...
    internal class DialogGuildInvitePlayer : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildinvite", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:invite-player-title"), OnTitleBarCloseClicked)
            ...
            string instructionText = availablePlayerNames.Count > 1
                ? Lang.Get("srguildsandkingdoms:invite-player-instructions")
            ...
            if (availablePlayerNames.Count > 1) // More than just the "Select player..." option
            {
                ...
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:player-name"),
                ...
                // Buttons
                composer.AddSmallButton(Lang.Get("srguildsandkingdoms:invite"), OnInviteClick,
            ...
            else
            {
                ...
                composer.AddSmallButton(Lang.Get("srguildsandkingdoms:close"), OnCancelClick,
                    ElementBounds.Fixed(0, top, 80, elementHeight), EnumButtonStyle.Normal);
            }
        ...
        private bool OnInviteClick()
        {
            ...
            if (selectedIndex <= 0)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:please-select-player"));
                return true;
            }
            ...
            if (networkHandler != null)
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:invite-sent", selectedPlayer.PlayerName));
            }
