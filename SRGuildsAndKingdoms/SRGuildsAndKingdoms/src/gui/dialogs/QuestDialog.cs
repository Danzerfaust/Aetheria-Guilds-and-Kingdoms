...
namespace SRGuildsAndKingdoms.src.gui.dialogs
{
    internal class QuestDialog : GuiDialog
    {
        ...
        public QuestDialog(ICoreClientAPI capi, SRGuildsAndKingdomsModSystem modSystem, string? questType = null) : base(capi)
        {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildquests", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:quests-tab-title"), OnTitleBarCloseClicked)
        ...
        private void SetupNoGuildDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildquests", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:quest-dialog-title"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);

            composer.AddStaticText(
                Lang.Get("srguildsandkingdoms:no-guild-message"),
