    ...
    internal class DialogGuildMembers : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildmembers", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:guild-members-title", currentGuild.Name), OnTitleBarCloseClicked)
            ...
            // Instructions
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:guild-members-instructions"),
            ...
            if (canKickMembers)
            {
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:member-actions"),
            ...
            if (members.Count == 0)
            {
                composer.AddStaticText(Lang.Get("srguildsandkingdoms:loading-members"),
            ...
            double elementHeight, double spacing)
        {
            ...
            var statusText = member.IsOnline
                ? Lang.Get("srguildsandkingdoms:status-online")
                : Lang.Get("srguildsandkingdoms:status-offline");
            ...
            var lastSeenText = member.IsOnline
                ? Lang.Get("srguildsandkingdoms:now")
            ...
            if (canKickMembers)
            {
                ...
                {
                    composer.AddSmallButton(Lang.Get("srguildsandkingdoms:kick"), () => OnKickMember(member),
        ...
        private void OnRoleChanged(GuildMemberInfo member, string newRole)
        {
            ...
            capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:role-change-sent", member.PlayerName, newRole));
        ...
        private bool OnKickMember(GuildMemberInfo member)
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-kick-self"));
                return false;
            }

            if (member.Role == "Leader")
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:cannot-kick-leader"));
                return false;
            }

            if (!canKickMembers)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:no-permission-kick"));
                return false;
            }
            ...
            var confirmDialog = new DialogKickConfirm(capi, member.PlayerName, () =>
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:kick-request-sent", member.PlayerName));
        ...
        private string FormatLastSeen(DateTime lastSeen)
        {
            ...
            if (timeSpan.TotalMinutes < 1)
                return Lang.Get("srguildsandkingdoms:just-now");
            if (timeSpan.TotalMinutes < 60)
                return Lang.Get("srguildsandkingdoms:minutes-ago", (int)timeSpan.TotalMinutes);
            if (timeSpan.TotalHours < 24)
                return Lang.Get("srguildsandkingdoms:hours-ago", (int)timeSpan.TotalHours);
            if (timeSpan.TotalDays < 7)
                return Lang.Get("srguildsandkingdoms:days-ago", (int)timeSpan.TotalDays);
            if (timeSpan.TotalDays < 30)
                return Lang.Get("srguildsandkingdoms:weeks-ago", (int)(timeSpan.TotalDays / 7));
        ...
        private void SetupNoGuildDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildmembers", dialogBounds)
                .AddShadedDialogBG(bgBounds)
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:guild-members-title", "None"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);
    ...
    internal class DialogKickConfirm : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildkickconfirm", dialogBounds)
                .AddShadedDialogBG(bgBounds)
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:kick-member-title"), OnTitleBarCloseClicked)
                .BeginChildElements(bgBounds);
            ...
            // Message
            var message = Lang.Get("srguildsandkingdoms:confirm-kick-member", memberName);
            ...
            // Buttons
            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:kick"), OnConfirmClick,
