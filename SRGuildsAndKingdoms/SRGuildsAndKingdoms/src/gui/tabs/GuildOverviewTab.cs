...
namespace SRGuildsAndKingdoms.src.gui.tabs
{
    public class GuildOverviewTab : GuildTabContent
    {
        ...
        public GuildOverviewTab(ICoreClientAPI capi, SRGuildsAndKingdomsModSystem modSystem,
        ...
        public override double AddContent(GuiComposer composer, double startTop)
        {
            ...
            composer.AddSmallButton(Lang.Get("srguildsandkingdoms:leave-guild"), onLeaveGuild,
