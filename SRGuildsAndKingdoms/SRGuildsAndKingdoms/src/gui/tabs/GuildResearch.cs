...
namespace SRGuildsAndKingdoms.src.gui.tabs
{
    internal class GuildResearch : GuildTabContent
    {
        ...
        public GuildResearch(ICoreClientAPI capi, SRGuildsAndKingdomsModSystem modSystem, GuildSummary? currentGuild, ActionConsumable onRefresh) : base(capi, modSystem, currentGuild)
        {
