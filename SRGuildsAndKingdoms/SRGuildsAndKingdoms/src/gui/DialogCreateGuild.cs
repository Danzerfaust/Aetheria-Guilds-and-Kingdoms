    ...
    internal class DialogCreateGuild : GuiDialog
    {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildcreate", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:create-guild-title"), OnTitleBarCloseClicked)
            ...
            // Instructions
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:create-guild-instructions"),
                CairoFont.WhiteSmallText(), ElementBounds.Fixed(0, top, 350, elementHeight));
            top += elementHeight + spacing;

            // Guild name input
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:guild-name"),
            ...
            composer.AddStaticText(Lang.Get("srguildsandkingdoms:guild-description"),
                CairoFont.WhiteSmallText(), ElementBounds.Fixed(0, top, 100, elementHeight));
            composer.AddTextInput(ElementBounds.Fixed(110, top, 200, elementHeight), null,
        ...
        private bool OnCreateClick()
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:please-enter-guild-name"));
                return true;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-name-too-short"));
                return true;
            }

            if (guildName.Length > 20)
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-name-too-long"));
                return true;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-name-invalid-chars"));
                return true;
            }
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-description-too-long"));
                return true;
            }
            ...
            if (networkHandler != null)
            {
                ...
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:guild-creation-sent", guildName));
            }
            else
            {
