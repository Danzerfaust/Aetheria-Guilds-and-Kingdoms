...
namespace SRGuildsAndKingdoms.src.gui
{
    ...
    public class DialogGuildInvitePopup : HudElement
    {
        ...
        public void ShowInvites(List<GuildInviteInfo> invites)
        {
            ...
            {
                capi.ShowChatMessage(Lang.Get("srguildsandkingdoms:no-pending-invites"));
            }
        }
        ...
        private void ComposeDialog()
        {
            ...
            {
                timeText = Lang.Get("srguildsandkingdoms:invite-expires-seconds", (int)timeRemaining.TotalSeconds);
            }
            else
            {
                timeText = Lang.Get("srguildsandkingdoms:invite-expires-minutes", (int)timeRemaining.TotalMinutes);
            }
            ...
            var composer = capi.Gui.CreateCompo("guildinvitepopup", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("srguildsandkingdoms:guild-invite-title"), OnCloseClicked)
            ...
            composer
                .AddStaticText(
                    Lang.Get("srguildsandkingdoms:guild-invite-message", currentInvite.GuildName, currentInvite.InviterName),
                ...
                .AddStaticText(
                    Lang.Get("srguildsandkingdoms:press-key-to-interact", capi.Input.GetHotKeyByCode("togglemousecontrol")?.CurrentMapping?.ToString() ?? "NOT SET"),
            ...
            if (currentInvites.Count > 1)
            {
                ...
                composer.AddStaticText(
                    Lang.Get("srguildsandkingdoms:invite-count", currentInviteIndex + 1, currentInvites.Count),
                    CairoFont.WhiteSmallText(),
                    countBounds
                );
            }
            ...
            composer
                .AddSmallButton(
                    Lang.Get("srguildsandkingdoms:accept"),
                    OnAcceptClicked,
                    acceptBounds,
                    EnumButtonStyle.Normal
                )
                .AddSmallButton(
                    Lang.Get("srguildsandkingdoms:decline"),
                    OnDeclineClicked,
                    declineBounds,
                    EnumButtonStyle.Normal
                );
        ...
        private bool OnAcceptClicked()
        {
            ...
            var channel = capi.Network.GetChannel("srguildsandkingdoms:guild");
