...
`VintageStoryData/ModConfig/SOAGuildsAndKingdoms/techblocks.json`

Auto-created with defaults if missing.

### Guild Progress Location
`VintageStoryData/ModData/SOAGuildsAndKingdoms/GuildTech/guild_{guildId}_tech.json`
...
### Config not loading?
- Check file path: `ModConfig/SOAGuildsAndKingdoms/techblocks.json`
- Check JSON syntax
