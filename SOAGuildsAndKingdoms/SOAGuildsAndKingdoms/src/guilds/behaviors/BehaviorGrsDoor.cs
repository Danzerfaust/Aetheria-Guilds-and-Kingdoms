...
namespace SOAGuildsAndKingdoms.src.guilds.behaviors
{
    public class BlockBehaviorGrsDoor(Block block) : BlockBehavior(block)
    {
        ...
        private bool HandleBlockInteract(IWorldAccessor world, IPlayer byPlayer)
        {
            ...
            {
                (world.Api as ICoreClientAPI)?.TriggerIngameError(this, "locked", Lang.Get("soaguildsandkingdoms:grsdoor-locked"));
            }
