...
namespace SOAGuildsAndKingdoms.src.database
{
    ...
    public class GuildDatabase : IDisposable
    {
        ...
        public GuildDatabase(ICoreServerAPI serverApi)
        {
            ...
            var dataFolder = serverApi.GetOrCreateDataPath("ModData/SOAGuildsAndKingdoms");
        ...
        public void Initialize()
        {
            try
            {
                serverApi.Logger.Notification($"[SOAGuildsAndKingdoms] Initializing database at: {databasePath}");
                ...
                serverApi.Logger.Notification("[SOAGuildsAndKingdoms] Database initialized successfully");
            }
            catch (Exception ex)
            {
                serverApi.Logger.Error($"[SOAGuildsAndKingdoms] Failed to initialize database: {ex.Message}");
        ...
        private void EnableWalMode()
        {
            ...
            {
                serverApi.Logger.Warning($"[SOAGuildsAndKingdoms] Failed to enable WAL mode: {ex.Message}");
            }
        }
        ...
        private void ConfigureConnection()
        {
            ...
            {
                serverApi.Logger.Warning($"[SOAGuildsAndKingdoms] Failed to apply some optimizations: {ex.Message}");
            }
        }
        ...
        public void Checkpoint()
        {
            try
            {
                ...
                serverApi.Logger.Debug($"[SOAGuildsAndKingdoms] Checkpoint performed: {result}");
            }
            catch (Exception ex)
            {
                serverApi.Logger.Error($"[SOAGuildsAndKingdoms] Checkpoint failed: {ex.Message}");
            }
        }
        ...
        public void CreateBackup(string backupPath)
        {
            try
            {
                ...
                serverApi.Logger.Notification($"[SOAGuildsAndKingdoms] Creating backup at: {backupPath}");
                ...
                serverApi.Logger.Notification("[SOAGuildsAndKingdoms] Backup created successfully");
            }
            catch (Exception ex)
            {
                serverApi.Logger.Error($"[SOAGuildsAndKingdoms] Backup failed: {ex.Message}");
                throw;
            }
        }
        ...
        public void Dispose()
        {
            ...
            try
            {
                ...
                serverApi.Logger.Debug("[SOAGuildsAndKingdoms] Database connection disposed");
            }
            catch (Exception ex)
            {
                serverApi.Logger.Error($"[SOAGuildsAndKingdoms] Error disposing database: {ex.Message}");
            }
            finally
            {
                isDisposed = true;
