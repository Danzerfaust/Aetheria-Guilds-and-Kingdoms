...
using SOAGuildsAndKingdoms.src.events;
using System;
using System.Linq;
...
namespace SOAGuildsAndKingdoms.src.network
{
    ...
    {
        public const string ChannelName = "soaguildsandkingdoms:event";
        public const string ManagerPrivilege = "soaguildsandkingdoms:eventmanager";
