...
namespace SOAGuildsAndKingdoms.src.network
{
    ...
    {
        private const string ChannelName = "soaguildsandkingdoms:party";
        ...
        public void InitializeServer(ICoreServerAPI api, PartyManager manager, SOAGuildsAndKingdomsModSystem modSystem)
        {
            serverApi = api;
