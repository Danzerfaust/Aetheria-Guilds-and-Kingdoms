...
namespace SOAGuildsAndKingdoms.src.gui
{
    public class DialogCreateOutpost : GuiDialog
    {
        ...
        public DialogCreateOutpost(ICoreClientAPI capi, SOAGuildsAndKingdomsModSystem modSystem, Action<string> onOutpostCreated) : base(capi)
        {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("createoutpost", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("soaguildsandkingdoms:create-outpost-title"), OnTitleBarCloseClicked)
            ...
            // Instructions
            composer.AddStaticText(Lang.Get("soaguildsandkingdoms:create-outpost-instructions"),
                CairoFont.WhiteSmallText(), ElementBounds.Fixed(0, top, 400, elementHeight * 2));
            top += elementHeight * 2 + spacing;

            // Outpost name input
            composer.AddStaticText(Lang.Get("soaguildsandkingdoms:outpost-name"),
            ...
            composer.AddStaticText(Lang.Get("soaguildsandkingdoms:outpost-name-optional"),
        ...
        private bool OnCreateClick()
        {
            ...
            if (!string.IsNullOrWhiteSpace(outpostName))
            {
                ...
                {
                    capi.ShowChatMessage(Lang.Get("soaguildsandkingdoms:outpost-name-too-long"));
                    return true;
                }
                ...
                {
                    capi.ShowChatMessage(Lang.Get("soaguildsandkingdoms:outpost-name-invalid-chars"));
                    return true;
                }
            }
