...
namespace SOAGuildsAndKingdoms.src.gui
{
    ...
    public class DialogGuildPendingInvites : GuiDialog
    {
        ...
        public DialogGuildPendingInvites(ICoreClientAPI capi, SOAGuildsAndKingdomsModSystem modSystem) : base(capi)
        {
        ...
        private void SetupDialog()
        {
            ...
            var composer = capi.Gui.CreateCompo("guildpendinginvites", dialogBounds)
                ...
                .AddDialogTitleBar(Lang.Get("soaguildsandkingdoms:pending-invites-title"), OnTitleBarCloseClicked)
            ...
            // Header
            composer.AddStaticText(Lang.Get("soaguildsandkingdoms:pending-invites-header", pendingInvites.Count),
            ...
            {
                composer.AddStaticText(Lang.Get("soaguildsandkingdoms:no-pending-invites"),
            ...
            else
            {
                ...
                for (int i = 0; i < pendingInvites.Count; i++)
                {
                    ...
                    composer.AddSmallButton(Lang.Get("soaguildsandkingdoms:cancel-invite"),
            ...
            // Refresh button
            composer.AddSmallButton(Lang.Get("soaguildsandkingdoms:refresh-invites"),
                OnRefresh,
                ElementBounds.Fixed(0, top, 120, elementHeight),
                EnumButtonStyle.Normal);

            // Close button
            composer.AddSmallButton(Lang.Get("soaguildsandkingdoms:close"),
                OnClose,
        ...
        private bool OnCancelInvite(string inviteeUid)
        {
            ...
            capi.ShowChatMessage(Lang.Get("soaguildsandkingdoms:invite-cancel-requested"));
        ...
        private bool OnRefresh()
        {
            LoadGuildData();
            SetupDialog();
            capi.ShowChatMessage(Lang.Get("soaguildsandkingdoms:invites-refreshed"));
            return true;
        }
