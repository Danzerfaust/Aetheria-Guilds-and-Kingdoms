...
namespace SOAGuildsAndKingdoms.src.gui.tabs
{
    ...
    public abstract class GuildTabContent
    {
        ...
        protected SOAGuildsAndKingdomsModSystem modSystem;
        protected GuildSummary? currentGuild;

        public GuildTabContent(ICoreClientAPI capi, SOAGuildsAndKingdomsModSystem modSystem, GuildSummary? currentGuild)
        {
            this.capi = capi;
