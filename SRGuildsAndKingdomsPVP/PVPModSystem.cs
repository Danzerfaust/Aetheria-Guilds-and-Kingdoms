...
using SRGuildsAndKingdomsPVP.src.pvp;
...
namespace SRGuildsAndKingdomsPVP
{
    /// <summary>
    ...
    public class PVPModSystem : ModSystem
    {
        ...
        public override void Start(ICoreAPI api)
        {
            ...
            api.Logger.Notification("[PVP] This mod requires SRGuildsAndKingdoms to be installed");
        ...
        public override void StartServerSide(ICoreServerAPI api)
        {
            ...
            if (guildMod == null)
            {
                api.Logger.Error("[PVP] CRITICAL ERROR: SRGuildsAndKingdoms mod is not loaded!");
                api.Logger.Error("[PVP] This mod cannot function without SRGuildsAndKingdoms.");
                api.Logger.Error("[PVP] Please install SRGuildsAndKingdoms mod (modid: srguildsandkingdoms)");
                return;
            }

            api.Logger.Notification("[PVP] SRGuildsAndKingdoms mod detected - initializing guild-based PVP");
        ...
        private TextCommandResult OnNodeWarAdminCommand(TextCommandCallingArgs args, SRGuildsAndKingdomsModSystem guildMod)
        {
            var player = args.Caller.Player as IServerPlayer;
            if (player == null)
                return TextCommandResult.Error("Command can only be used by players");
        ...
        public NodeWarTabData? GetNodeWarDataForGuild(string guildName)
        {
            ...
            var guildMod = serverApi.ModLoader.GetModSystem<SRGuildsAndKingdomsModSystem>();
            if (guildMod == null)
                return null;
        ...
        /// </summary>
        public void OnNodeWarDataRequested(IServerPlayer player, string guildName, SRGuildsAndKingdomsModSystem guildMod)
        {
