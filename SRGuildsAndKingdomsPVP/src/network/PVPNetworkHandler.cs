...
using SRGuildsAndKingdomsPVP.src.utils;
...
namespace SRGuildsAndKingdomsPVP.src.network
{
    ...
    {
        private const string CHANNEL_NAME = "srguildsandkingdomspvp:main";
        ...
        private void OnNodeWarGuildSignup(IServerPlayer player, NodeWarGuildSignupPacket packet)
        {
            ...
            var guildMod = serverApi.ModLoader.GetModSystem<SRGuildsAndKingdoms.SRGuildsAndKingdomsModSystem>();
